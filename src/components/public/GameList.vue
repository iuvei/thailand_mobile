﻿<template>
    <div class='GameList'>
        <div class="BuyBox">
            <div class="BuyNav">
                <span @click="Rightleft()" id="Buyleft"><img src="http://mobile.beike188.com/modelTTC/images/BuyColor/left.png" alt=""></span>
                <div class="BuyNavBox">
                    <ul class="BuyNavList">
                ...
                <span @click="LertRight()" id="Buyright"><img src="http://mobile.beike188.com/modelTTC/images/BuyColor/right.png" alt=""></span>
            </div>
        </div>
